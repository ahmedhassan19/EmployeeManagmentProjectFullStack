...
<div class="modal-content">
    ...
    <div class="modal-body">
       ...
       <div class="input-group mb-3"  v-if="DepartmentId!=0" >
            <span class="input-group-text">Department Id</span>
            <input type="text" class="form-control" v-model="DepartmentId" readonly> 
       </div>
        ...
        v-if="DepartmentId==0" class="btn btn-primary" :disabled="!validateModal()">
        Create
        </button>
